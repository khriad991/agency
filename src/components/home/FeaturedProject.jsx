    ...
    return (
        <div className="bg-green2 py-10">
            <div className="container">
                ...
                />
                <div className=" justify-between sm:flex flex-wrap lg:flex-nowrap gap-y-8 mt-4 pt-2 pb-8">
                    <div className="w-full lg:w-[48%] hidden sm:flex justify-start items-start">
