                                ...
                                <div className="w-full relative z-0">
                                    ...
                                    <div className=" flex items-end w-full h-full opacity-0 hover:opacity-100 bg-opacity-10 bg-black absolute bottom-0 left-0 z-10 myTransition ">
                                        <div className=" flex justify-center items-center bg-gray1 gap-x-3 py-4 px-8 mx-auto mb-8 w-[200px] px-20 rounded-3xl ">
                                            <Link target="_blank" rel="noopener noreferrer" className=" border-r-2 border-[#737588] hover:text-green3 text-[#737588 myTransition" href={item["facebook"]}>
                                                <FaFacebook size={25} className="mr-4" />
                                            </Link>
                                            <Link target="_blank" className=" border-r-2 border-[#737588] hover:text-green3 text-[#737588 myTransition" href={item["twitter"]}>
                                                <FaTwitter size={25} className="mr-4" />
                                            </Link>
                                            <Link target="_blank" className="hover:text-green3 text-[#737588 myTransition" href={item["instagram"]}>
