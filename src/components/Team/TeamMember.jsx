        ...
        <div className="bg-white py-10">
            <div className="container">
                ...
                <div className="flex justify-between gap-y-5 gap-x-4">
                    {
                        data.map((item,id)=>(
                            <div key={id} className="w-[32%] flex flex-col bg-white shadow-4xl pb-8">
                                <div className="max-w-[390px] my-6 relative z-0">
                                    <Image className="object-cover w-full rounded-xl" src={item["image"]} alt="team" width={390} height={387} />
